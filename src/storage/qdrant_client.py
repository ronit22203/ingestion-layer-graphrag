...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python manage_qdrant.py list                    # List all collections
  python manage_qdrant.py stats                   # Get collection statistics
  python manage_qdrant.py clear                   # Clear all points in collection
  python manage_qdrant.py delete                  # Delete entire collection
  python manage_qdrant.py delete my_collection    # Delete specific collection
  python manage_qdrant.py -c config.yaml list    # Use custom config file
        """
    )
